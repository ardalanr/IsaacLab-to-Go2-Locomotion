...
# RUN apt-get install -y build-essential cmake git wget curl

# # Install Python 3.8 from official Python.org (safer alternative)
# RUN apt-get install -y wget build-essential zlib1g-dev libncurses5-dev libgdbm-dev libnss3-dev libssl-dev libreadline-dev libffi-dev libsqlite3-dev libbz2-dev
